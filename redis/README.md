...
| scooter.aux-battery.charging-system-warning | "show"/"suppress" | Dashboard AUX charging-system warning: notification, charging-condition telltale and status-bar AUX warning icon | "show" |
| scooter.cb-battery.charging-system-warning | "show"/"suppress" | Dashboard connectivity-box charging-system warning: notification and status-bar CB warning icon | "show" |
