...
| CB warning icon | CBB charge < 50%, not charging, main pack present/active, seatbox closed (3s debounce); or CBB reports low charge while no main pack is inserted ("stranded"). The charging branch is silenced by `scooter.cb-battery.charging-system-warning` | Blank battery glyph with an error overlay |
| AUX warning icon | AUX charger reports not-charging while the main pack is active and AUX voltage is below the 14500 mV charger ceiling (3s debounce); or AUX voltage < 11495 mV (or < 11000 mV critical), main pack present, seatbox closed; or AUX voltage < 11700 mV while no main pack is inserted ("stranded"). The charging branch is silenced by `scooter.aux-battery.charging-system-warning` | Blank battery glyph with an error overlay |
