...
[Generic settings](#generic-settings) for the complete contract.
...
All extended commands, including generic settings, require the
...
| 9a59a042 | Mileage/Odometer | Signed 32-bit little-endian integer, meters (read-only) |
