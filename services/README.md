...
| [librescoot-uplink](librescoot-uplink.md) | Cloud connectivity client (WebSocket telemetry, events, remote commands) | `remote-access` (own provider field), `internet[unu-cloud]` (legacy mirror) | Redis, uplink-server, NTP |
